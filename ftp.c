...
typedef void (*ftp_command_fn)(ftp_client_t *, const char *, u16_t);
 ...
 */
static void cmd_syst(ftp_client_t *, const char *, u16_t);
static void cmd_user(ftp_client_t *, const char *, u16_t);
static void cmd_pass(ftp_client_t *, const char *, u16_t);
static void cmd_list(ftp_client_t *, const char *, u16_t);
static void cmd_quit(ftp_client_t *, const char *, u16_t);
static void cmd_port(ftp_client_t *, const char *, u16_t);
static void cmd_pasv(ftp_client_t *, const char *, u16_t);
static void cmd_type(ftp_client_t *, const char *, u16_t);
static void cmd_pwd(ftp_client_t *, const char *, u16_t);
static void cmd_cwd(ftp_client_t *, const char *, u16_t);
static void cmd_cdup(ftp_client_t *, const char *, u16_t);
static void cmd_opts(ftp_client_t *, const char *, u16_t);
static void cmd_put(ftp_client_t *, const char *, u16_t);
static void cmd_get(ftp_client_t *, const char *, u16_t);
static void cmd_size(ftp_client_t *, const char *, u16_t);
static void cmd_feat(ftp_client_t *, const char *, u16_t);
static void cmd_dele(ftp_client_t *, const char *, u16_t);
...
static char _banner[] = "Welcome to the BND's FTP micro server.\r\n200 (c) 2010-2011 KSC Elcom, LLC.";
 ...
 */
static void
exec_command(ftp_client_t *fc, char *text, u16_t cmdlen)
{
    int i;
    struct _ftp_cmd *cmd;
...
static void 
cmd_syst(ftp_client_t *fc, const char *args, u16_t len)
{
...
static void 
cmd_user(ftp_client_t *fc, const char *args, u16_t len)
{
...
static void 
cmd_pass(ftp_client_t *fc, const char *args, u16_t len)
{
    if(0 == strlen(fc->user)) {
...
static void 
cmd_quit(ftp_client_t *fc, const char *args, u16_t len)
{
    msg(fc, 220, "Goodbye");
...
static void 
cmd_opts(ftp_client_t *fc, const char *args, u16_t len)
{
    msg(fc, 200, "Ok");
}
...
static void 
cmd_cwd(ftp_client_t *fc, const char *args, u16_t len)
{
    if('/' == args[0]) {
...
static void 
cmd_cdup(ftp_client_t *fc, const char *args, u16_t len)
{
    msg(fc, 250, "CWD command successful");
}
...
static void
_format_date(char *dst, u16_t cb, u16_t date, u16_t time)
{
...
static void
cmd_size(ftp_client_t *fc, const char *args, u16_t len)
{
    u32_t fs;
    FILINFO fi;
...
static void
cmd_feat(ftp_client_t *fc, const char *args, u16_t len)
{
...
static void 
cmd_list(ftp_client_t *fc, const char *args, u16_t len)
{
    DIR dir;
    FILINFO file;
    FRESULT res;
...
static void 
cmd_pasv(ftp_client_t *fc, const char *args, u16_t len)
{
    u16_t port;
    char reply[64];
    struct sockaddr_in name;
    
    port = (u16_t)(40000 + rand() % 25500);
...
static void 
cmd_pwd(ftp_client_t *fc, const char *args, u16_t len)
{
...
static void
cmd_type(ftp_client_t *fc, const char *args, u16_t len)
{
...
static void 
cmd_put(ftp_client_t *fc, const char *args, u16_t len)
{
    FRESULT err;
    char path[PATH_MAX];
...
static void 
cmd_get(ftp_client_t *fc, const char *args, u16_t len)
{
    FRESULT err;
    u32_t rd, total;
    FIL f;
 ...
 */
static void 
cmd_dele(ftp_client_t *fc, const char *args, u16_t len)
{
    char path[PATH_MAX];
    FRESULT res;
    FILINFO fi;
...
static void 
cmd_port(ftp_client_t *fc, const char *args, u16_t len)
{
